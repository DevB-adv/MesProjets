...
public class ExecutionBis {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "would you like to play morpion with hints , yes or no ???"
    );
    String answer = scanner.next();

    if (answer.equals("yes")) {
      TicTacToeWithHints play = new TicTacToeWithHints(inputStr, inputStr2); // instantiation du jeu
      ...
      while (!play.isOver()) {
        ...
        while (!play.isValid2(inputStr6)) { // tant que le coup n'est pas valide on demande à l'utilisateur de reéssayer
          System.out.println(
        ...
        System.out.println("\n");
        System.out.println(play.toString2()); // on affiche le plateau
