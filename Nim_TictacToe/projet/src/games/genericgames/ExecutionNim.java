...
public class ExecutionNim { //meme classe d'execution que celle dans nim saauf que les joueurs sont de types Human
  ...
  public static void main(String[] args) {
    ...
    Human p2 = new Human(inputStr, scanner);
    ...
    Nim play = new Nim(inputInt, inputInt2, p1, p2);
