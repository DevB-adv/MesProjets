...
public class Taquin extends AbstractListenableModel{
    ...
    /**
        ...
        * @param int lignes correspond aux nombre de lignes qu'on souhaite avoir dans le taquin
        * @param int colonnes correspond aux nombre de colonnes qu'on souhaite avoir dans le taquin 
    */
    ...
    /**
        ...
        * @param int tailleLigne correspond à la dimension en ligne
        * @param int tailleColonne correspond à la dimension en colonne
    ...
    */
    ...
    /**
        ...
        * @param Tuile tuile correspond à la tuile que l'on souhaite changer
    */
    ...
    */
    ...
    /** 
        ...
        * @param int pos_x correspond à la position en x
        * @param int pos_y correspond à la position en y
    ...
    */
    ...
    /** 
        ...
        * @param int identifiant correspond à l'identifiant de la tuile
    ...
    */
    ...
    /** 
        ...
        * @param Tuile[][] plateauInit prend le plateau initial
        * @param Tuile[][] plateauFinal prend le plateau final
    ...
    */
    ...
    /** 
        ...
        * @return un tableau de booleen true si la tuile est déplaçable, false sinon
    */
